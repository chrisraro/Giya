...
interface MobileCustomerBottomNavProps {
  onQrScan: () => void
  onPunchCardScan?: () => void
}

export function MobileCustomerBottomNav({ onQrScan, onPunchCardScan }: MobileCustomerBottomNavProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="relative h-16 flex items-center justify-between px-4 py-3">
        ...
        {/* Punch Card Scanner - Right Center */}
        {onPunchCardScan && (
          <div className="flex flex-col items-center gap-1">
            <Button
            ...
            <span className="text-xs font-medium text-muted-foreground">Punch</span>
          </div>
        )}
