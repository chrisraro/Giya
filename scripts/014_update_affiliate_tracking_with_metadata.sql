-- Update the affiliate tracking function to use referral code from user metadata
...
-- Update the function to award points to influencers for customer transactions
